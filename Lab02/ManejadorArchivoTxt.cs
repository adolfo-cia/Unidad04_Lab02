...
namespace Lab02
{
    ...
    {
        // en ese connection string:
        //      HDR = Yes : indica que el primer registro contiene encabezados
        //      FMT = CSVDelimited : indica que los campos estan delimitados por un caracter ','
        //      @ es para evitar tener que usar \\ para escribir la barra invertida en el string
